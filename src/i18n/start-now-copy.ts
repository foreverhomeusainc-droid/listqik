...
const COPY: Record<HomeLocale, StartNowCopy> = {
  en: {
    ...
    offer: {
      ...
      kicker: "Flat-fee MLS listing",
      title: "Subsonic — list on the MLS for $79",
      body: "Broker-backed MLS listing with transparent upfront pricing. No traditional ~3% listing commission.",
      coupon: "Continue from this page to start seller intake.",
      cta: "Get Subsonic for $79",
      floating: "List for $79",
    },
  ...
  es: {
    ...
    offer: {
      ...
      kicker: "Listado MLS tarifa fija",
      title: "Subsonic — publique en el MLS por $79",
      body: "Listado MLS con respaldo de correduría y precio inicial transparente. Sin comisión tradicional de ~3% del listado.",
      coupon: "Continúe desde esta página para iniciar el intake del vendedor.",
      cta: "Obtener Subsonic por $79",
      floating: "Publicar por $79",
    },
