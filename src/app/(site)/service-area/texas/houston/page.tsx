...
export const metadata = metroRegionalMetadata("houston", "en");
...
export default async function HoustonRegionalPage({
  searchParams,
}: {
  ...
  return <MetroRegionalLandingPage metroId="houston" locale="en" />;
}
