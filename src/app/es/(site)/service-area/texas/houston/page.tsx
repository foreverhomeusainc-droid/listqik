...
export const metadata = metroRegionalMetadata("houston", "es");
...
export default async function EsHoustonRegionalPage({
  searchParams,
}: {
  ...
  return <MetroRegionalLandingPage metroId="houston" locale="es" />;
}
