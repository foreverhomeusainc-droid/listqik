...
export const metadata = metroRegionalMetadata("san-antonio", "es");
...
export default async function EsSanAntonioRegionalPage({
  searchParams,
}: {
  ...
  return <MetroRegionalLandingPage metroId="san-antonio" locale="es" />;
}
