...
/**
 * POST /api/dashboard/listings/[id]/gallery/upload
 *
 * Server-side proxy upload for additional listing photos. Same contract as the
 * hero-image upload route — multipart `file` field in, `{ ok, key, publicUrl }`
 * out.
 */
